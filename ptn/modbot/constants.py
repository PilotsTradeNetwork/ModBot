...
PROD_CHANNEL_MBDEV = 1152651370852257870  # PTN ModBot Dev Channel
PROD_CHANNEL_ATLAS = 986025300477509643  # PTN Atlas channel
PROD_CHANNEL_PRIV = 986028207117590548  # PTN Privileged channel
PROD_CHANNEL_FORUM = 1171139329670787102  # PTN forum channel
PROD_CHANNEL_CCO_WMM = 827972977727242250  # PTN CCO WMM Channel
PROD_CHANNEL_TOW_TRUCK = 927958105684312144  # PTN impound-lot channel
PROD_ROLE_COUNCIL = 800091021852803072  # PTN Council role
PROD_ROLE_MOD = 813814494563401780  # PTN Mod role
PROD_ROLE_TOW_TRUCK = 925833571409723423  # PTN Tow Truck role
PROD_ROLE_SOMMELIER = 838520893181263872  # PTN Sommelier role - Unused
...
PROD_BC_CATEGORIES = [1077429676470976512, 1077428970439577710,
                      838515215950807100]  # Admin Area, Wine Carriers, Booze Cruise - Unused
...
TEST_CHANNEL_MBDEV = 1152652768994132031
TEST_CHANNEL_CCO_WMM = 1186715490094166087
TEST_CHANNEL_TOW_TRUCK = 1186432504698245120
TEST_ROLE_COUNCIL = 877586918228000819
TEST_ROLE_MOD = 903292469049974845
TEST_ROLE_SOMMELIER = 849907019502059530
TEST_ROLE_TOW_TRUCK = 1186432184643485756
...
def role_tow_truck():
    return PROD_ROLE_TOW_TRUCK if _production else TEST_ROLE_TOW_TRUCK
...
def channel_cco_wmm():
    return PROD_CHANNEL_CCO_WMM if _production else TEST_CHANNEL_CCO_WMM


def channel_tow_truck():
    return PROD_CHANNEL_TOW_TRUCK if _production else TEST_CHANNEL_TOW_TRUCK
...
def dev_channel():
    return PROD_CHANNEL_MBDEV if _production else TEST_CHANNEL_MBDEV
