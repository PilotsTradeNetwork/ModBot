...
# define bot object
bot = commands.Bot(command_prefix='modbot ', intents=discord.Intents.all())
...
PROD_CHANNEL_BOTDEV = 1152651370852257870 # PTN channel related to development for modbot
...
TEST_CHANNEL_BOTDEV = 1152652768994132031 # PANTS channel related to development for modbot
